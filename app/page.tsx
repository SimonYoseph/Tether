...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    <section className="search-header"><div className="subheader-line"><span>Your thought space</span><b>|</b><strong>Keep the good stuff.</strong></div><div className="global-search"><Search size={18} /><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search notes by keyword or title..." /><kbd>/</kbd></div></section>
