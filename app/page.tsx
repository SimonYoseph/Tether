...
import { CircleUserRound, Link2, LoaderCircle, LogOut, Moon, Plus, Search, Sun, Tag, X } from "lucide-react";
...
export default function Home() {
  ...
  useEffect(() => {
    if (window.localStorage.getItem("tether-theme") === "dark") document.documentElement.dataset.theme = "dark";
  }, []);
  ...
  function toggleTheme() {
    ...
    window.localStorage.setItem("tether-theme", nextTheme ? "dark" : "light");
  }
